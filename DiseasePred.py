...
dia_model = pickle.load(open("Saved Models/Diabetes.sav", 'rb'))
heart_model = pickle.load(open("Saved Models/Heart.sav", 'rb'))
park_model = pickle.load(open("Saved Models/Parkinsons.sav", 'rb'))
